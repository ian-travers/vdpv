      ...
      <div class="col-10">
        ...
        <section id="requirement">
          ...
          <p class="mb-5">Для работы приложения необходим компьютер с доступом в Единую сеть передачи данных Белорусской
            железной дороги.<br>
            "Учет задержанных и длительно простаивающих вагонов" являет веб-приложением и для запуска необходим один из
            ...
            веб-приложений (сайт, ссылка, заполнение форм и т.д.)
          </p>
        </section>
      </div>
    </div>
