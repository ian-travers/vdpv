    ...
    <div class="row mt-3">
      ...
      <div class="col-10">
        ...
        <section id="interface">
          <h4 class="mt-5">Интерфейс приложения</h4>
        ...
        <section id="root-page">
          <h4 class="mt-5">Главная страница</h4>
          ...
          <p>
            ...
            инвентарному номеру вагона (целиком или частично) или по наименованию собственника.
          </p>
        </section>

        <section id="reports">
          <h4 class="mt-5">Формирование отчетов</h4>
        ...
        <section id="manage-wagons">
          ...
          <p class="mb-1 text-secondary">В разработке</p>
          <p class="mb-1"></p>
          <p class="mb-1"></p>
          <p class="mb-1"></p>
          <p class="mb-1"></p>
