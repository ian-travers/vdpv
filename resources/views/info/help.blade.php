      ...
      <div class="col-10">
        <section id="annotation">
          ...
          <p class="mb-1">Приложение предназначено для осуществения <strong>оперативного контроля</strong> за
            вагонами, задержанными и длительно простаивающими на станции. Информация в приложении наполняется авторизованными пользователями, уполномоченными вносить сведения о задержанных и простаивающих вагонах. В приложении можно формировать отчеты для определения состояния по задержанным вагонам на конкретный момент времени или за указанный период.</p>
        ...
        <section id="interface">
          ...
          <p class="mb-1">В интерфейсе сайта веб-проложения используются цветовые элементы:<br>
            ...
            <span class="text-secondary">74961624</span> &mdash; на контроле (завершена грузовая операция для местных вагонов или выпущен для остальных вагонов),<br>
        ...
        <section id="root-page">
          ...
          <p class="mb-1">Главное меню включает логотип приложения:<br>
            <img src="{{ asset('storage/images/tank-wagon.png') }}" alt="" width="36" class="mr-3">, ссылка по которому
